...
const SuccessHero = ({ orderData }) => {
  return (
    <div className="w-full flex flex-col items-center text-center py-8">
      ...
      {/* WhatsApp Banner */}
      <div className="mt-6 flex items-center gap-3 bg-success-muted text-success px-4 py-3 rounded-xl border border-success-border text-xs font-medium max-w-md w-full">
