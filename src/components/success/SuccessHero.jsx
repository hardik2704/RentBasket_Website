...
const SuccessHero = ({ orderData }) => {
  return (
    <div className="w-full flex flex-col items-center text-center py-8">
      ...
      {/* WhatsApp Banner */}
      <div className="mt-6 flex items-center gap-3 bg-[#E8F8F5] text-[#1D8348] px-4 py-3 rounded-xl border border-[#D5F5E3] text-xs font-medium max-w-md w-full"> // ignore-harness — design-sprint debt, tracked in review-promotions.md
