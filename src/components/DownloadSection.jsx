          ...
          <div className="flex flex-col items-start md:max-w-md md:ml-0 mx-auto md:mx-0">
            ...
            <div className="flex lg:hidden flex-row gap-3 w-full items-center justify-center">
              <a
                ...
                className="w-full"
              >
                <button className="flex items-center justify-center gap-2 rounded-full bg-white px-5 py-3 text-coral-darker transition-transform hover:scale-105 w-full border border-gray-100 shadow-sm">
            ...
            <div className="hidden lg:flex flex-col gap-3 md:gap-4 w-full md:w-auto items-start">
              <a
                ...
                rel="noopener noreferrer"
              >
                <button className="flex items-center justify-start gap-3 rounded-full bg-white px-8 py-4 text-coral-darker transition-transform hover:scale-105 w-72 border border-gray-100 shadow-md hover:shadow-lg">
